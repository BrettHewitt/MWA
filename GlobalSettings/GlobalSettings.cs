...
namespace RobynsWhiskerTracker.GlobalSettings
{
    public static class GlobalSettings
    {
        public static IUnitSettings UnitSettings;
        public static IColorSettings ColorSettings;
        public static IClipSettings ClipSettings;
        public static IFrameRateSettings FrameRateSettings;
