...
namespace RobynsWhiskerTracker.ViewModel.Analyser.Methods.WhiskerFrequency
{
    public class SingleWhiskerFrequencyViewModel : SingleWhiskerBase
    {
        private ISingleWhiskerFrequency m_Model;

        public ISingleWhiskerFrequency Model
        {
            get
            {
                return m_Model;
        ...
        public void NotifyFrequencyChanged()
        {
