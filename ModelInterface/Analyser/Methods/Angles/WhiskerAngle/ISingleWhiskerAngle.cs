...
namespace RobynsWhiskerTracker.ModelInterface.Analyser.Methods.Angles.WhiskerAngle
{
    public interface ISingleWhiskerAngle : ISingleWhiskerCurve
    {
        double TValue
        {
            get;
