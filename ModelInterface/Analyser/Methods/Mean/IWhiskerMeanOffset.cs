...
namespace RobynsWhiskerTracker.ModelInterface.Analyser.Methods.Mean
{
    public interface IWhiskerMeanOffset : IModelObjectBase
    {
        string Name
        {
            get;
        ...
        ISingleWhiskerMeanOffset[] Whiskers
        {
            get;
        }
