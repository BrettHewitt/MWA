...
{
    internal abstract class AngleTypeBase : ModelObjectBase, IAngleTypeBase
    {
        public string Name
        {
            get;
        ...
        protected AngleTypeBase(string name)
        {
            Name = name;
        }

        public abstract double CalculateAngle(Vector vector);
        public abstract IAngleTypeBase GetInstance();
